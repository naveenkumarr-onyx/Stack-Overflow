...
import comment_alt from "../../assets/comment-alt-solid.svg";
import pen_solid from "../../assets/pen-solid.svg";
import black_logo from "../../assets/blacklogo.svg";
const Widget = () => {
  return (
    <div className="widget right-sidebar">
      <h4>The Overflow Blog</h4>
      <div className="right-sidebar-div-1">
        <div className="right-sidebar-div-2">
          <img src={pen_solid} alt="pen" width="18" />
          <p>
      ...
      <div className="right-sidebar-div-1">
        <div className="right-sidebar-div-2">
          <img src={comment_alt} alt="pen" width="18" />
        ...
        <div className="right-sidebar-div-2">
          <img src={black_logo} alt="pen" width="18" />
          <p>
